...
drwAutoGui::drwAutoGui(QObject *target, QWidget *parent)
...
void drwAutoGui::AddIntSliderParam(QString paramName, int minVal, int maxVal) {
  IntSliderGuiParam *param =
      new IntSliderGuiParam(this, paramName, minVal, maxVal);
  m_params.push_back(param);
}

void drwAutoGui::AddDoubleSliderParam(QString paramName, double minVal,
                                      double maxVal) {
  DoubleSliderGuiParam *param =
      new DoubleSliderGuiParam(this, paramName, minVal, maxVal);
  m_params.push_back(param);
}
...
// IntSlider
// ----------------------------------------------------------------
IntSliderGuiParam::IntSliderGuiParam(drwAutoGui *parent, QString name,
...
const char *IntSliderGuiParam::GetValueName() { return m_name.toUtf8().data(); }

// ----------------------------------------------------------------
// DoubleSlider
// ----------------------------------------------------------------
DoubleSliderGuiParam::DoubleSliderGuiParam(drwAutoGui *parent, QString name,
...
int DoubleSliderGuiParam::ParamValueToSliderValue(double paramValue) {
  int sliderVal =
      (int)((paramValue - m_range[0]) / (m_range[1] - m_range[0]) * 100);
  return sliderVal;
}

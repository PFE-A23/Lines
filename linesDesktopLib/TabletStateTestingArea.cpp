...
TabletStateTestingArea::TabletStateTestingArea(QWidget *parent)
    : QOpenGLWidget(parent), m_logMoveEvents(true) {}
...
void TabletStateTestingArea::enterEvent(QEvent *) { m_parent->LogEnterEvent(); }

void TabletStateTestingArea::leaveEvent(QEvent *) { m_parent->LogLeaveEvent(); }

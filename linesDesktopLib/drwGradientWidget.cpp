...
drwGradientWidget::drwGradientWidget(QWidget *parent)
    : QWidget(parent), m_vertical(false), m_cursorWidth(10), m_cursorHeight(5),
      m_sliderValue(.5), m_leftButtonPressed(false) {}
...
bool drwGradientWidget::isVertical() { return m_vertical; }

...
TabletStateWidget::TabletStateWidget(QWidget *parent) : QWidget(parent) {
  ...
  QTabletEvent event(QEvent::TabletEnterProximity, QPoint(0, 0), QPointF(0, 0),
                     QTabletEvent::NoDevice, QTabletEvent::UnknownPointer, 0, 0,
                     0, 0, 0, 0, 0, 0);
  UpdateUi(&event);
}
...
void TabletStateWidget::LogTabletEvent(QTabletEvent *e) {
  QString logText;
  logText += QString("Tablet: %1 (id:%2);")
                 .arg(TabletEventTypeToString(e))
                 .arg(e->uniqueId());
...
void TabletStateWidget::on_clearLogButton_clicked() { ui.logWidget->clear(); }

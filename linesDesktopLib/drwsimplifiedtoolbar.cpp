...
drwSimplifiedToolbar::drwSimplifiedToolbar(QWidget *parent)
    : QWidget(parent), ui(new Ui::drwSimplifiedToolbar), m_app(0),
      m_vertical(false),
...
drwSimplifiedToolbar::~drwSimplifiedToolbar() { delete ui; }
...
void drwSimplifiedToolbar::SetApp(LinesApp *app) {
  ...
  connect(m_app, SIGNAL(NetworkManagerStateChangedSignal()), this,
          SLOT(UpdateUI()));
}

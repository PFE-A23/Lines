...
public:
  ...
  void SetMessageFromThread(MessageFromThread msg) {
    m_messageFromThread = msg;
  }
...
protected:
  ...
  // Function called when thread starts. It is started when the class is
  // instanciated
  void run();

  LinesCore *m_lines;

  // Queued commands to send and mutex to protect it since it is accessed by
  // main and net threads
  QMutex m_queueMutex;
...
public:
  ...
  void SetMessageToThread(drwNetworkManager::MessageToThread msg) {
    m_messageToThread = msg;
  }

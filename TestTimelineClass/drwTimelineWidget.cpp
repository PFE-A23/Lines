...
drwTimelineWidget::drwTimelineWidget(QWidget *parent)
    : QWidget(parent), m_scene(0), m_layerHeight(30), m_frameLength(20),
      currentMouseX(0), currentMouseY(0), lastMouseX(0), lastMouseY(0),
      mouseMoving(false), isScaling(false), isPaning(false), isMoving(false) {
  setAcceptDrops(true);

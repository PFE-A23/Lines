...
ExportDialog::ExportDialog(QString &defaultPath, int defaultXRes,
                           int defaultYRes, QWidget *parent)
    : QDialog(parent) {
  ui.setupUi(this);
...
QString ExportDialog::GetFileName() { return ui.fileEditBox->text(); }
...
void ExportDialog::on_browseButton_clicked() {
  ...
  QString newPath = QFileDialog::getSaveFileName(
      this, tr("Export to bitmap"), currentPath, tr("PNG Files (*.png)"));
  if (!newPath.isEmpty())
